...
public class PolynomialTest {
    ...
    public void testToStringUnique1() {
        ...
        assertEquals(test.toString(),"0","Empty list of terms INCORRECT");
        ...
        for(int i = 0; i < UNIQUE_TERMS1.length; i++) {
            ...
            assertEquals( expected, actual,"Expected and actual polynomial toString DON'T match");
        }
    }
    ...
    public void testUniqueAddTermTypeByFinalPositions1() {
        ...
        for(int i = 0; i < UNIQUE_TERMS1.length; i++) {
            ...
            assertEquals( expectedOrderedTerm, actualOrderedTerm,"Expected and actual term DON'T match");
        }
    }
    ...
    public void testAddPolynomials() {
        ...
        for(int i = 0; i < test1.getNumTerms(); i++) {
            ...
            assertEquals(expectedTerm, actualTerm, "Expected and actual term DON'T match");
        }
    }
    ...
    public void testCopyConstructor() {
        ...
        for(int i = 0; i < original.getNumTerms(); i++) {
            ...
            assertTrue( originalTerm != copyTerm, "Shallow copy of Term object in Polynomial");
